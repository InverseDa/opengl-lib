...
// std::shared_ptr<Mesh> TextureMesh::createMesh(std::vector<Vertex> vertices,
//                                               std::vector<GLuint> indices,
//                                               std::vector<Texture> textures)
//                                               {
...
// TextureMesh::TextureMesh(std::vector<Vertex> vertices,
//                          std::vector<GLuint> indices,
//                          std::vector<Texture> textures)
...
// inline void TextureMesh::draw(Shader &shader) {
//   GLuint diffuseNr = 1;
//   GLuint specularNr = 1;
//   GLuint normalNr = 1;
//   GLuint heightNr = 1;
